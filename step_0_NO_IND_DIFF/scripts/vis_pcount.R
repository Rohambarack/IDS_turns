...
save_it(pp_1,"../plots/P_count/step_0_PP_pcount.pdf")
...
save_it(pp_2,"../plots/P_count/step_0_PP_pcount_sd.pdf")
...
save_it(pp_3,"../plots/P_count/step_0_PP_pcount_hu.pdf")
...
save_it(vis_1,"../plots/P_count/step_0_pcount.pdf")
...
save_it(vis_2,"../plots/P_count/step_0_pcount_sd.pdf")
...
save_it(vis_3,"../plots/P_count/step_0_pcount_hu.pdf")
