...
y_iqr_f0 <- bf(iqr_f0 ~ 0 + ASD + ASD:Visit +  ASD:Socialization + ASD:MotorSkills + ASD:CHI_MLU + (1 + Visit + Socialization + MotorSkills + CHI_MLU |gr(Participant, by=ASD)),
...
saveRDS(iqr_model,"../models/step_2_iqr_f0_3.rds")